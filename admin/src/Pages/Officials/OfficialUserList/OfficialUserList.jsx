...
// import { getUsers } from "../../redux/features/auth/authSlice"; // Import getUsers from the appropriate location
// import { deleteUser } from "../../redux/features/officials/officialAuthSlice"; // Import the deleteUser action from the officialAuthSlice
...
import CreateOfficial from "../CreateOfficials/CreateOfficials";

const OfficialUsersList = () => {
  const dispatch = useDispatch();
  const { officialUsers, isLoading } = useSelector(
    (state) => state.officialAuth
  ); // Update the selector to get officialUsers from officialAuth

  console.log("getOfficialUsers in the officialUserList", officialUsers);
  ...
  const totalUsers = officialUsers.length;
  const suspendedUsers = officialUsers.filter(
  ...
  const filteredUsers = officialUsers.filter((user) => {
    ...
    <section className="user-list">
      <div className="container">
        <Box textAlign="center">
          <Typography variant="h4">Official Users</Typography>
        </Box>
        <Box
          display="flex"
        ...
        >
          ...
          <TextField
            ...
            // }}
            // InputProps={{
            //   style: { height: "60px" }, // Adjust the height value as needed
            // }}
          />
          {/* </div> */}
                ...
                <Table>
                  ...
                  >
                    <TableRow>
                      ...
                      <TableCell>Raids DOne</TableCell>
...
export default OfficialUsersList;
